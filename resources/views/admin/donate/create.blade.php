...
@section('content')
    ...
    <div class="white-bx">
        <h3 class="sub-heading">Add Donate</h3>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-space">
                        ...
                        <img class="mt-2" src="{{ url('admin_assets/images/' . $homeLogo->donate_image) }}" alt=" "
                            width="512px" height="250px" id="donate_img" />
                    </div>
                </div>
            </div>
    ...
    <script>
        const logoImg = document.getElementById('donate_img');
