...
@section('content')
    ...
    <div class="white-bx">
        <h3 class="sub-heading">Add Privacy Policy Spanish</h3>

        <form action="{{ route('privacy-policy-spanish.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-space">
                        <label for="">Privacy Policy Spanish*</label>
                        ...
                        <br />
                        <img class="mt-2" src="{{ url('admin_assets/images/' . $homeLogo->pp_spanish_image) }}"
    ...
    <script>
        const logoImg1 = document.getElementById('pp_spanish_img');
