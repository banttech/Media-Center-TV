    ...
    <aside class="app-sidebar">
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item @if (isset($pageTitle) && $pageTitle === 'Manage Songs') active @endif"
                    href="{{ route('apps.index') }}"><img src="{{ url('admin_assets/images/ic1.svg') }}"
                        alt=""> <span class="app-menu__label">Apps</span></a></li>

            <li><a class="app-menu__item @if (isset($pageTitle) && $pageTitle === 'Manage Customers') active @endif"
                    href="{{ route('manage-customers.manage') }}"><img src="{{ url('admin_assets/images/ic1.svg') }}"
                        alt=""> <span class="app-menu__label">Customers</span></a></li>

            <li><a class="app-menu__item @if (isset($pageTitle) && ($pageTitle === 'Edit Privacy Policy' || $pageTitle === 'Add Privacy Policy')) active @endif"
                    href="{{ route('privacy-policy-english') }}"><img src="{{ url('admin_assets/images/ic1.svg') }}"
                        alt=""> <span class="app-menu__label">Privacy Policy English</span>
                </a>
            </li>
            <li><a class="app-menu__item @if (isset($pageTitle) && ($pageTitle === 'Edit Privacy Policy' || $pageTitle === 'Add Privacy Policy')) active @endif"
                    href="{{ route('privacy-policy-spanish') }}"><img src="{{ url('admin_assets/images/ic1.svg') }}"
                        alt=""> <span class="app-menu__label">Privacy Policy Spanish</span>
                </a>
            </li>
            <li><a class="app-menu__item @if (isset($pageTitle) && ($pageTitle === 'Edit Help Instruction' || $pageTitle === 'Add Help Instruction')) active @endif"
                    href="{{ route('help-instruction-english') }}"><img src="{{ url('admin_assets/images/ic1.svg') }}"
                        alt=""> <span class="app-menu__label">Help Instruction English</span>
                </a>
            </li>

            <li><a class="app-menu__item @if (isset($pageTitle) && ($pageTitle === 'Edit Help Instruction' || $pageTitle === 'Add Help Instruction')) active @endif"
                    href="{{ route('help-instruction-spanish') }}"><img src="{{ url('admin_assets/images/ic1.svg') }}"
                        alt=""> <span class="app-menu__label">Help Instruction Spanish</span>
                </a>
            </li>

            <li><a class="app-menu__item @if (isset($pageTitle) && ($pageTitle === 'Edit Contact Us' || $pageTitle === 'Add Contact Us')) active @endif"
                    href="{{ route('contact-us') }}"><img src="{{ url('admin_assets/images/ic1.svg') }}"
                        alt=""> <span class="app-menu__label">Contact Us</span>
                </a>
            </li>
            <li><a class="app-menu__item @if (isset($pageTitle) && ($pageTitle === 'Edit Donate' || $pageTitle === 'Add Donate')) active @endif"
                    href="{{ route('donate') }}"><img src="{{ url('admin_assets/images/ic1.svg') }}" alt="">
                    <span class="app-menu__label">Donate</span>
                </a>
            </li>


            <li><a class="app-menu__item @if (isset($pageTitle) && $pageTitle === 'Update Logo') active @endif"
                    href="{{ route('update-logo') }}"><img src="{{ url('admin_assets/images/ic1.svg') }}"
                        alt=""> <span class="app-menu__label">Update Logo</span></a></li>
            <li><a class="app-menu__item @if (isset($pageTitle) && $pageTitle === 'Edit Profile') active @endif"
                    href="{{ route('profile.edit') }}"><img src="{{ url('admin_assets/images/ic1.svg') }}"
                        alt=""> <span class="app-menu__label">Profile</span></a></li>
            <li><a class="app-menu__item" href="{{ route('user.logout') }}"><img
                        src="{{ url('admin_assets/images/ic1.svg') }}" alt="">
